	...
	render() {
		...
		return(
			<div className='main-page'>
				<h1 className={this.props.pageStateReducer.pageState === 'heloves' ? '' : 'hide'}>
            Welcome to my world <span>,Sandip..</span></h1>
				...
				<div className='increase-page'>
					<a className={this.props.pageStateReducer.pageState === 'heloves' ? 'btn btn-red' : 'hide'}
  href='#' onClick={this.changeState}>He Loves</a>
					<a className={this.props.pageStateReducer.pageState === 'back' ? 'btn btn-red' : 'hide'}
  href='#' onClick={this.changeStateAgain}>back</a>
				</div>
			</div>
		)
	}
